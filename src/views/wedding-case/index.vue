<template>
    <div class="wedding-wrap">
        ...
        <div class="color-card-wrap">
            <div v-for="item in dataList.list" class="color-card" :style="{background:`linear-gradient(180deg,${item.colorValue},85%,#FFB6C1)`}">
                {{ item.colorName }}
                <div>
                    {{ item.desc }}
                </div>
...
import WeddingProvider from '@/provider/wedding'
